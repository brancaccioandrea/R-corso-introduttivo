...
knitr::include_graphics("img/coRso.png")
```
...
`https://ottaviae.github.io/coRso/`
...
La logica è che l'oggetto a destra (l'operazione e quindi il risultato che se ne ottiene) viene assegnato (`=` oppure `<-`) alla variabile (o oggetto) a destra
