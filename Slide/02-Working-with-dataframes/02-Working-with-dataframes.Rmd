...
<!-- my_data = data.frame(sbj = paste("sbj", 1:12, sep ="_"),  -->
<!--                      genere = rep(c("male", "female"), each = 6),  -->
<!--                      benessere = rpois(12, 4),  -->
<!--                      stipendio = rpois(12, 67)*100) -->

<!-- with(my_data, interaction.plot(stipendio, genere, benessere)) -->
<!-- ``` -->
